...
func (c *cmd) Help(ctx context.Context, message telego.Message) error {
	msg := `/start - Welcome & subagent options
/help - Show this help message
/show [model|channel] - Show current configuration
/list [models|channels] - List available options
/status - Show running subagents
/spawn - Quick: spawn 2 subagents
/custom - Enter your own tasks (one per line)
/go - Spawn your custom tasks
/cancel - Cancel custom spawn
/model [id] - Set or show LLM model
	`
