...
// MemoryStore is the interface for agent memory backends (filesystem, S3).
// Used by read_file, write_file, append_file when path is under memory/.
type MemoryStore interface {
	...
	WriteDailyNote(date, content string) error
