...
**Jacked Jeff Bezos** *(singing into a gold mic, one foot on a monitor)*:
"Your agent FORGETS — every time you restart —"
...
"SCALE HORIZONTALLY — like these LATS — AWS tools BUILT IN — that's a FACT —"
